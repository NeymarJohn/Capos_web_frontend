...
export class ContinueSaleComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    this.statuses.push({value: 'all_open', label: 'All Open Sales'});
    for(let s of Constants.sale_status) {
      if(Constants.continue_status.includes(s.value)) this.statuses.push(s);
    }
  }
