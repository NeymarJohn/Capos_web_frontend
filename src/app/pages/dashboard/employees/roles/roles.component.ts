...
export class RolesComponent implements OnInit {
  ...
  addRole(){
    this.route.navigate(['/dashboard/employees/role-action'], {queryParams: {mode: 'add'}});
  }

  editRole(role) {
    this.route.navigate(['/dashboard/employees/role-action'], {queryParams: {_id: role._id, mode: 'edit'}});
  }
